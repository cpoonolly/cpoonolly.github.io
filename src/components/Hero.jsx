    ...
    <header className="relative w-full min-h-screen flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <a
            href="#projects"
            className="inline-block px-8 py-3 rounded-full font-medium border border-slate-600 text-gray-300 hover:border-slate-400 hover:text-white transition-all hover:scale-105"
          >
            See My Work
          </a>
        </div>
